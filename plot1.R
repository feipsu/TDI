...
c + geom_bar(stat = "identity") + ylab("Annual Cost in 2015 (dollars)") + xlab("Geography Division") + theme(axis.text.y=element_text(size=15,colour = "black"),axis.text.x=element_text(size=15,colour = "black",angle=45, hjust=1),axis.title=element_text(size=15)) + ylim(c(0,3000)) + theme(legend.title = element_blank()) + theme(legend.text=element_text(size=15))
